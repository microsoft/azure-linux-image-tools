...
func TestInjectFilesOptionsVerifyPreviewFeatures_CosiCompressionLevelWithoutFeature_Fail(t *testing.T) {
	options := InjectFilesOptions{
...
func TestInjectFilesOptionsVerifyPreviewFeatures_CosiCompressionWithFeature_Pass(t *testing.T) {
	options := InjectFilesOptions{
		CosiCompressionLevel: 15,
	}
	previewFeatures := []imagecustomizerapi.PreviewFeature{
...
func TestInjectFilesOptionsVerifyPreviewFeatures_NoOptionsWithCosiCompressionFeature_Pass(t *testing.T) {
	options := InjectFilesOptions{}
	previewFeatures := []imagecustomizerapi.PreviewFeature{
		imagecustomizerapi.PreviewFeatureCosiCompression,
	}
...
func TestInjectFilesOptionsVerifyPreviewFeatures_NoOptionsNoFeatures_Pass(t *testing.T) {
	options := InjectFilesOptions{}
	previewFeatures := []imagecustomizerapi.PreviewFeature{}
	err := options.verifyPreviewFeatures(previewFeatures)
	assert.NoError(t, err)
