...
func (b *LiveOSIsoBuilder) updateGrubCfg(isoGrubCfgFileName string, pxeGrubCfgFileName string,
	...
	dracutSupportsSELinux := true
	err = verifyDracutLiveISOSELinuxSupport(savedConfigs.OS.DracutPackageInfo)
	if err != nil {
		dracutSupportsSELinux = false
	}

	selinuxPolicySupportsLiveOSIso := true
	err = verifySELinuxPolicyLiveOSISOSupport(savedConfigs.OS.SELinuxPolicyPackageInfo)
	if err != nil {
