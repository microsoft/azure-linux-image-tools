...
func updateSavedConfigs(savedConfigsFilePath string, newKernelArgs imagecustomizerapi.KernelExtraArguments,
	...
	updatedSavedConfigs.OS.SELinuxRequestedMode = requestedSelinuxMode
	...
	if savedConfigs != nil {
		...
		if requestedSelinuxMode != imagecustomizerapi.SELinuxModeDefault {
			updatedSavedConfigs.OS.SELinuxRequestedMode = savedConfigs.OS.SELinuxRequestedMode
		}
...
func (b *LiveOSIsoBuilder) prepareLiveOSDir(inputSavedConfigsFilePath string, writeableRootfsDir string,
	...
	if imageSELinuxMode != imagecustomizerapi.SELinuxModeDisabled {
		...
		if err != nil {
			...
			if updatedSavedConfigs.OS.SELinuxRequestedMode != imagecustomizerapi.SELinuxModeDisabled &&
				updatedSavedConfigs.OS.SELinuxRequestedMode != imagecustomizerapi.SELinuxModeDefault {
...
func (b *LiveOSIsoBuilder) createImageFromUnchangedOS(baseConfigPath string, isoConfig *imagecustomizerapi.Iso,
	...
	if b.artifacts.selinuxPolicyPackageInfo != nil {
		return fmt.Errorf("incorrect assumption 1!!")
	}
	if b.artifacts.dracutPackageInfo != nil {
		return fmt.Errorf("incorrect assumption 2!!")
	}
