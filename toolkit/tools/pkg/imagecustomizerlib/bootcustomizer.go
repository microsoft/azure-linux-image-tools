...
func (b *BootCustomizer) AddKernelCommandLine(extraCommandLine []string) error {
	...
	case bootConfigTypeUki:
		// UKI boot configuration doesn't use grub config files.
		// Kernel command-line args are managed through UKI-specific mechanisms.
	}
...
func (b *BootCustomizer) PrepareForVerity() error {
	...
	case bootConfigTypeUki:
		// UKI boot configuration doesn't use grub config files.
		// Verity parameters are handled through UKI cmdline files.
	}
...
func (b *BootCustomizer) WriteToFile(imageChroot safechroot.ChrootInterface) error {
	...
	case bootConfigTypeUki:
		// UKI boot configuration doesn't use grub config files.
		// UKI files are written directly by UKI-specific customization logic.
	}
