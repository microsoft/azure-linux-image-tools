...
const (
	...
	// Matches both "grub2-mkconfig" (Azure Linux, Fedora) and "grub-mkconfig" (Ubuntu, Debian).
	grubMkconfigHeader = "automatically generated by grub"
...
// assignment to the variable that matches the provided name.
