...
// - isXBootLdrPartition: Will the partition contain the /boot directory?
func getFileSystemOptions(targetOs targetos.TargetOs, filesystemType string, isXBootLdrPartition bool) ([]string, error) {
	...
	case "xfs":
		options, err := getXfsFileSystemOptions(hostKernelVersion, options, isXBootLdrPartition)
		if err != nil {
			return nil, err
		}
...
func getXfsFileSystemOptions(hostKernelVersion version.Version, options fileSystemsOptions, isXBootLdrPartition bool,
) ([]string, error) {
