...
func CreatePartitions(targetOs TargetOs, diskDevPath string, disk configuration.Disk, rootEncryption configuration.RootEncryption,
...
func formatSinglePartition(targetOs TargetOs, partDevPath string, partition configuration.Partition,
	...
	case "fat32", "fat16", "vfat", "ext2", "ext3", "ext4", "xfs":
		...
		if err != nil {
			err = fmt.Errorf("failed to get mkfs args for filesystem type (%s)", fsType)
			return fsType, err
		}
