...
var (
	...
	outputImageFormat        = app.Flag("output-image-format", fmt.Sprintf("Format of output image. Supported: %s.", strings.Join(imagecustomizerapi.SupportedImageFormats(), ", "))).Enum(imagecustomizerapi.SupportedImageFormats()...)
