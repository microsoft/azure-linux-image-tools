...
func main() {
	...
	err := imagecreatorlib.CreateImageWithConfigFileAndPreviewFeatures(ctx, cli.BuildDir, cli.ConfigFile, cli.RpmSources,
		cli.ToolsTar, cli.OutputImageFile, cli.OutputImageFormat, cli.Distro, cli.DistroVersion,
		cli.PackageSnapshotTime, cliPreviewFeatures)
	if err != nil {
