...
- [config type](./configuration/config.md)
  - [input](./configuration/config.md#input-input) ([input type](./configuration/input.md))
    ...
    - [verityHashes](./configuration/input.md#verityhashes-inputverityhashes) ([inputVerityHashes type](./configuration/inputVerityHashes.md))
      - [path](./configuration/inputVerityHashes.md#path-string)
    - [ukis](./configuration/input.md#ukis-inputukis) ([inputUkis type](./configuration/inputUkis.md))
      - [path](./configuration/inputUkis.md#path-string)
    - [bootloader](./configuration/input.md#bootloader-inputbootloader) ([inputBootloader type](./configuration/inputBootloader.md))
      - [path](./configuration/inputBootloader.md#path-string)
  ...
  - [output](./configuration/config.md#output-output) ([output type](./configuration/output.md))
    ...
    - [verityHashes](./configuration/output.md#verityhashes-outputverityhashes) ([outputVerityHashes type](./configuration/outputVerityHashes.md))
      - [path](./configuration/outputVerityHashes.md#path-string)
    - [ukis](./configuration/output.md#ukis-outputukis) ([outputUkis type](./configuration/outputUkis.md))
      - [path](./configuration/outputUkis.md#path-string)
    - [bootloader](./configuration/output.md#bootloader-outputbootloader) ([outputBootloader type](./configuration/outputBootloader.md))
      - [path](./configuration/outputBootloader.md#path-string)
