...
| [os.packages](./configuration/os.md#packages-packages)                                   | Yes                   | Yes                   | Preview             | Preview                   |
| &emsp;[.updateExistingPackages](./configuration/packages.md#updateexistingpackages-bool) | Yes                   | Yes                   | Preview             | Preview                   |
| &emsp;[.installLists](./configuration/packages.md#installlists-string)                   | Yes                   | Yes                   | Preview             | Preview                   |
| &emsp;[.install](./configuration/packages.md#install-string)                             | Yes                   | Yes                   | Preview             | Preview                   |
| &emsp;[.removeLists](./configuration/packages.md#removelists-string)                     | Yes                   | Yes                   | Preview             | Preview                   |
| &emsp;[.remove](./configuration/packages.md#remove-string)                               | Yes                   | Yes                   | Preview             | Preview                   |
| &emsp;[.updateLists](./configuration/packages.md#updatelists-string)                     | Yes                   | Yes                   | Preview             | Preview                   |
| &emsp;[.update](./configuration/packages.md#update-string)                               | Yes                   | Yes                   | Preview             | Preview                   |
...
| [os.bootloader](./configuration/os.md#bootloader-bootloader)                             | Yes                   | Yes                   | No                  | No                        |
| [os.uki](./configuration/os.md#uki-uki)                                                  | Yes                   | Preview               | No                  | Preview                   |
| [os.selinux](./configuration/os.md#selinux-selinux)                                      | Yes                   | Yes                   | No                  | Preview                   |
