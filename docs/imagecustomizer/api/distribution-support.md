...
| &emsp;[.removeLists](./configuration/packages.md#removelists-string)                     | Yes                   | Preview             |
| &emsp;[.remove](./configuration/packages.md#remove-string)                               | Yes                   | Preview             |
| &emsp;[.updateLists](./configuration/packages.md#updatelists-string)                     | Yes                   | Preview             |
| &emsp;[.update](./configuration/packages.md#update-string)                               | Yes                   | Preview             |
