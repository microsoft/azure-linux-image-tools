...
Supports either:
- A date in `YYYY-MM-DD` format (interpreted as UTC midnight), or
- A full RFC 3339 timestamp (e.g., `2024-05-20T23:59:59Z`)

You may enable this feature by adding package-snapshot-time to the [previewfeatures](./configuration/config.md#previewfeatures-string) API.