...
- `<RELEASE>` is the version of Image Customizer that you are using (e.g.: v0.12).
...
```json
"yaml.schemas": {
    "https://raw.githubusercontent.com/microsoft/azure-linux-image-tools/release/v0.12/toolkit/tools/imagecustomizerapi/schema.json": [
